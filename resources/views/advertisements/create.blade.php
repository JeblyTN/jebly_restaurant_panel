    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="cat-edite-page max-width-box">
                        <div class="card  pb-4">
                            <div class="card-body">
                                ...
                                <div class="row restaurant_payout_create max-w-100">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-100 review-rating-input">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" id="review" name="review" value="review" checked>
                                                        <label class="control-label" for="review">{{ trans('lang.review') }}</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" id="rating" name="rating" value="rating" checked>
                ...
                <div class=" create-right col-lg-6 col-md-12 col-sm-12 page-btn">
...
@section('scripts')
    <script>
        ...
        if (copiedAd) {
            ...
            (title == '') ? $('#preview-title').html("{{trans('lang.title')}}"): $('#preview-title').html(title);
            $(".description").val(data.description);
            var description = data.description;
            (description != '') ? $('#placeholder-desc').addClass('d-none'): $('#placeholder-desc').removeClass('d-none');
            (description == '') ? $('#preview-desc').html("{{trans('lang.description')}}"): $('#preview-desc').html(description);
                ...
                if (copiedAd) {
                    ...
                    Promise.all(promises).then(() => {
                        database.collection('advertisements').doc(id).set({
                            ...
                            'video': videoFile,
                            // 'vendorId': vendorId,
                            'vendorId': (authRole == 'vendor') ? vendorId : empVendorId,
                            'priority': "N/A",
                            'type': advType,
                            'showRating': rating,
                            'showReview': review,
        ...
        async function handleVideoSelect(evt) {
            ...
            video.onloadedmetadata = function() {
                ...
                if (width > (height * 1.7)) {
                    ...
                    $(".error_top").show().html("<p>{{trans('lang.only_landscape_videos_are_allowed')}}</p>");
                    window.scrollTo(0, 0);
                    isVideo.value = '';
                    return false;
                }
