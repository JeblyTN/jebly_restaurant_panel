   ...
   <script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", async function() {    
        if (authRole === 'employee') {               
            ...
            ref = database.collection('restaurant_orders').orderBy('createdAt', 'desc').where('vendor.author',"==",authorId).where('status','==','Order Placed');
            refData = database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",user_id).where('status','==','Order Placed')

        }else{
            ref = database.collection('restaurant_orders').orderBy('createdAt', 'desc').where('vendor.author',"==",user_id).where('status','==','Order Placed');
            refData = database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",user_id).where('status','==','Order Placed');
        }
