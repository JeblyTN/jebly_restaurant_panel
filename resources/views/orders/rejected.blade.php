...
@section('scripts')
   <script type="text/javascript">
    ...
    var refData = database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",user_id).where('status','==','Order Rejected');
    var ref = database.collection('restaurant_orders').orderBy('createdAt', 'desc').where('vendor.author',"==",user_id).where('status','==','Order Rejected');
    var append_list = '';
    var user_number = [];
    var currentCurrency ='';
    ...
    document.addEventListener("DOMContentLoaded", async function() {    
        if (authRole === 'employee') {               
            ...
            ref = database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",authorId).where('status','==','Order Rejected');
            refData =  database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",authorId).where('status','==','Order Rejected')

        }else{
            ref = database.collection('restaurant_orders').orderBy('createdAt', 'desc').where('vendor.author',"==",user_id).where('status','==','Order Rejected');
            refData = database.collection('restaurant_orders').where('isPosOrder','==',false).where('vendor.author',"==",user_id).where('status','==','Order Rejected');
        }
