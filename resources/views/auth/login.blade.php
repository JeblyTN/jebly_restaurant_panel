...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    #googleBtn * {
     ...
     #googleBtn #container-div{width: 100%}
    </style>
    <body>
        ...
        <style type="text/css">
            ...
            [type="radio"]:checked + label::after, [type="radio"].with-gap:checked + label::after{
                background: <?php echo $_COOKIE['store_panel_color']; ?> !important;
                border: 2px solid <?php echo $_COOKIE['store_panel_color']; ?> !important;
             }
        </style>
        <?php } ?>
        <?php
                ...
                <div class="login-box card" style="margin-bottom:0%;">
                    <div class="card-body">
                        @if (count($errors) > 0)
                            ...
                            @endforeach
                        @endif
                        <div id="google_error" class="error mt-2" style="display:none;"></div>
                        <form class="form-horizontal form-material" name="login" id="login-box">
                            @csrf
                            <div class="box-title m-b-20 font-bold">{{ __('Login') }}</div>
