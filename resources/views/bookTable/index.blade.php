    ...
    <script type="text/javascript">
        ...
        async function buildHTML(val) {
            ...
            if (val.status == "Order Rejected") {
                statustext = '<span class="badge badge-danger py-2 px-3">{{trans("lang.request_rejected")}}</span>';
            } else if (val.status == "Order Placed") {
                statustext = '<span class="badge badge-warning py-2 px-3">{{trans("lang.requested")}}</span>';
            } else if (val.status == "Order Accepted") {
                statustext = '<span class="badge badge-success py-2 px-3">{{trans("lang.request_accepted")}}</span>';
            }
            html.push('<td>' + statustext + '</td>');
            var actionHtml = '<span class="action-btn">';
           
            actionHtml += '<a id="' + val.id + '" name="book-table-check" data-name="' + val.vendor.title + '" data-auth="' + val.author.id + '" href="javascript:void(0)"><i class="fa fa-check"></i></a>';

            actionHtml += '<a id="' + val.id + '" name="book-table-dismiss" data-auth="' + val.author.id + '" data-name="' + val.vendor.title + '" href="javascript:void(0)"><i class="fa fa-close"></i></a>';
           
            actionHtml += '<a href="' + route1 + '"><i class="fa fa-edit"></i></a>';
            
            actionHtml += '<a id="' + val.id + '" name="book-table-delete" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a>';
